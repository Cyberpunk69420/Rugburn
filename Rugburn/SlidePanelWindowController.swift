...
final class SlidePanelWindowController: NSWindowController, NSWindowDelegate {
    ...
    // Expose pin state so AppController can respect it
    ...
    init() {
        ...
        // Note: global click monitoring and auto-hide are now handled by AppController.
    }

    deinit {
        // No local global monitors or timers to clean up; AppController owns them.
    }
